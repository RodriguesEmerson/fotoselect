...
export function NotificationBox() {
   ...
   useClickOutside(refComponent, () => setIsOpen(false));
   ...
   return (
      <>
         <div
            className='modal relative flex items-center justify-center h-9 w-9 rounded-xl bg-[var(--background)] border-2 border-[var(--border-color)] cursor-pointer hover:brightness-95 transition-all'
         ...
         >
            ...
            <div className='h-fit max-h-[calc(100vh-5rem)] overflow-y-scroll pb-5 pt-5'>
               {noti.length > 0
