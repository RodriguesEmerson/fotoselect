...
export function DashboardGalleries({galleries}) {
   ...
   return (
      <div className="flex-1 min-w-88 ma shadow-[0_0_10px_5px_var(--shadow)] border border-[var(--border-color)] bg-[var(--background)] rounded-xl overflow-hidden">
         ...
         <div className="flex flex-row justify-between items-center p-2 px-4 border-b border-[var(--border-color)]" >
            ...
            <Link href={'http://localhost:3000/galleries'} className="text-sm text-[var(--primary-color)]">Ver todas</Link>
         </div>
