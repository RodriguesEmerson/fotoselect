...
export function DefaultInputText({ name, label, id, type = 'text', errorMessage, ...props }) {
   return (
      <div className="relative w-full">
         ...
         <input type={type} name={name} id={id} {...props} className="w-full h-8 pl-2 text-sm bg-white border border-gray-300 rounded-md outline-gray-600 light-autofill" autoComplete="on"/>
         {errorMessage &&
